...
if(isset($_POST['insert'])){
    $sec = new Section();
    $sql = $sec->addSection($_POST['cid'],$_POST['dep'],$_POST['yr'],$_POST['sec'],$_POST['str'],$_POST['venue']);
    if($sql){
...
<body class="login">
	...
	<tr>
    <th>ClassId</th>
    <td><input id="cid" class="form-control input-lg" name="cid" type="text" placeholder="1234" required></td>
  </tr>
  <tr>
    <th>Department</th>
    <td><input id="dep" class="form-control input-lg" name="dep" type="text" placeholder="abcd" required></td>
  </tr>
  <tr>
    <th>Year</th>
    <td><input id="yr" class="form-control input-lg" name="yr" type="text" placeholder="10" required></td>
  </tr>
  <tr>
    <th>Venue</th>
    <td><input id="section" class="form-control input-lg" name="sec" type="text" placeholder=" " required></td>
  </tr>
  <tr>
    <th>Strength</th>
    <td><input id="str" class="form-control input-lg" name="str" type="text" placeholder=" " required></td>
  </tr>
  <tr>
    <th>Venue</th>
    <td><input id="venue" class="form-control input-lg" name="venue" type="text" placeholder=" " required></td>
  </tr>
  </table>
  <br>
  <p align="center"><button type="submit" class="btn btn-success btn-lg btn-block" name="insert"><b>Create Class</h4></button></p>
			</form>
		</div>
  </body>
    <script >
