<?php 
 ...
 // create query
 $query = "SELECT * FROM users WHERE usrn='".$_POST['username']."' AND pass='".$_POST['password']."'";
...
<head>
  ...
  <title>TimeTable Management system Login</title>
	...
	<div class="container">
        ...
        <div class="checkbox pull-left">
			  ...
			  <div class="checkbox pull-right">
			    <label> <a class="forget" href="disptab.php" title="forget">Are You a Student?</a> </label>
			  </div>
			</form>
		</div>
    </div>
